...
public class AdCreativeLinkData extends APINode {
            ...
            if (result.isJsonArray()) {
                ...
                if (obj.has("data")) {
                    if (obj.has("paging")) {
                        ...
                        adCreativeLinkDatas.setPaging(paging);
                    }
    ...
    public AdCreativeLinkData setFieldAppLinkSpec(String value) {
        Type type = new TypeToken<AdCreativeLinkDataAppLinkSpec>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldCallToAction(String value) {
        Type type = new TypeToken<AdCreativeLinkDataCallToAction>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldChildAttachments(String value) {
        Type type = new TypeToken<List<AdCreativeLinkDataChildAttachment>>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldImageCrops(String value) {
        Type type = new TypeToken<AdsImageCrops>() {
        }.getType();
