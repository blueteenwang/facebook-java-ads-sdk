...
public class TargetingGeoLocation extends APINode {
            ...
            if (result.isJsonArray()) {
                ...
                if (obj.has("data")) {
                    if (obj.has("paging")) {
                        ...
                        targetingGeoLocations.setPaging(paging);
                    }
    ...
    public TargetingGeoLocation setFieldCities(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationCity>>() {
        }.getType();
    ...
    public TargetingGeoLocation setFieldCustomLocations(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationCustomLocation>>() {
        }.getType();
    ...
    public TargetingGeoLocation setFieldElectoralDistricts(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationElectoralDistrict>>() {
        }.getType();
    ...
    public TargetingGeoLocation setFieldGeoMarkets(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationMarket>>() {
        }.getType();
    ...
    public TargetingGeoLocation setFieldPlaces(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationPlace>>() {
        }.getType();
    ...
    public TargetingGeoLocation setFieldRegions(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationRegion>>() {
        }.getType();
    ...
    public TargetingGeoLocation setFieldZips(String value) {
        Type type = new TypeToken<List<TargetingGeoLocationZip>>() {
        }.getType();
